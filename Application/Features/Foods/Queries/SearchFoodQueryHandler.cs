...
{
    public class SearchFoodQueryHandler : IRequestHandler<SearchFoodQuery, FoodsDtoPaging>
    {
        ...
        public async Task<FoodsDtoPaging> Handle(SearchFoodQuery request, CancellationToken cancellationToken)
        {
